...
lv_obj_set_style_bg_color(root, 0x121005)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic Mini Claw"
local PHASE = "Phase 5 bridge app"
local MISSING_A = "Missing runtime:"
local MISSING_B = "app-service, http-callback, bridge-config"
