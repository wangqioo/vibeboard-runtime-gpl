...
lv_obj_set_style_bg_color(root, 0x06120f)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic Devtools"
local PHASE = "Phase 4 service app"
local MISSING_A = "Missing runtime:"
local MISSING_B = "app-service, web-routes, file-management"
