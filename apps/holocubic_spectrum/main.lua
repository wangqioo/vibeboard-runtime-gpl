...
lv_obj_set_style_bg_color(root, 0x100412)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic Spectrum"
local PHASE = "Phase 3 audio visual"
local MISSING_A = "Missing runtime:"
local MISSING_B = "native-spectrum, input, lvgl-extra"
