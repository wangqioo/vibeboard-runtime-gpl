...
lv_obj_set_style_bg_color(root, 0x120606)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic LV Benchmark"
local PHASE = "Phase 6 benchmark"
local MISSING_A = "Missing runtime:"
local MISSING_B = "lvgl-broad-surface, benchmark-metrics"
