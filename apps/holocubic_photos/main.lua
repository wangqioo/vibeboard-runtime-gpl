...
lv_obj_set_style_bg_color(root, 0x120711)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic Photos"
local PHASE = "Phase 3 media app"
local MISSING_A = "Missing runtime:"
local MISSING_B = "input, lvgl-canvas, image-decoders"
