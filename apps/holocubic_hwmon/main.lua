...
lv_obj_set_style_bg_color(root, 0x061005)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic HWMon"
local PHASE = "Phase 2 host monitor"
local MISSING_A = "Missing runtime:"
local MISSING_B = "http-callback, lvgl-canvas"
