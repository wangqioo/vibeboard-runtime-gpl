...
lv_obj_set_style_bg_color(root, 0x041014)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic Fluid Pendant"
local PHASE = "Phase 2 canvas visual"
local MISSING_A = "Missing runtime:"
local MISSING_B = "lvgl-canvas, time-compat"
