...
lv_obj_set_style_bg_color(root, 0x070605)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic BTC"
local PHASE = "Phase 2 data display"
local MISSING_A = "Missing runtime:"
local MISSING_B = "lvgl-canvas, http-callback, time-compat"
