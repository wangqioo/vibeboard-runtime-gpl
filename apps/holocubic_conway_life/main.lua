...
lv_obj_set_style_bg_color(root, 0x03110a)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic Conway Life"
local PHASE = "Phase 2 canvas sim"
local MISSING_A = "Missing runtime:"
local MISSING_B = "lvgl-canvas"
