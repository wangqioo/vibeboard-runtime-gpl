...
lv_obj_set_style_bg_color(root, 0x05070a)
lv_obj_set_style_text_color(root, 0xf8fafc)

local APP_NAME = "Holocubic 2048"
local PHASE = "Phase 3 input game"
local MISSING_A = "Missing runtime:"
local MISSING_B = "input, lvgl-animation, lvgl-style-extra"
