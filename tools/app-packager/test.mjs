...
describe("packageDemoApps", () => {
  ...
  it("packages the curated demo and migrated apps", () => {
    ...
    assert.deepEqual(result.map((item) => item.appId).sort(), ["2048", "clock", "conway_life", "fluid_pendant", "matrix_rain", "nesgame", "nixie_clock", "smoke_app_manager", "smoke_key", "smoke_nes", "voice_ai", "weather"]);
  });
});
